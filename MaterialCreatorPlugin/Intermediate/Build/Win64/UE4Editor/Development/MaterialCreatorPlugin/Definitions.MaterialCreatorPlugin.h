#undef MATERIALCREATORPLUGIN_API
...
#define UE_PROJECT_NAME LezioneGeotech
#define UE_TARGET_NAME LezioneGeotechEditor
...
#define MATERIALCREATORPLUGIN_API DLLEXPORT
